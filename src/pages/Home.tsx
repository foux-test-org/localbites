...
export function Home({ isFavorite, onFavorite, onViewMenu, onToast }: HomeProps): React.ReactNode {
    // FOUX_TODO: replace with the real rating review counts — one string per card slot
    const fouxRatingCounts = ["(214)", "(229)", "(178)", "(257)", "(205)", "(154)", "(233)", "(182)"];
    // FOUX_TODO: end
    // FOUX_TODO: replace with the real distance and time info — one string per card slot
    ...
    // FOUX_TODO: end
    // Note: widen the featured.map callback from (restaurant) => to (restaurant, index) => to bind the index used above
