...
export function Home({ isFavorite, onFavorite, onViewMenu, onToast }: HomeProps): React.ReactNode {
    // FOUX_TODO: replace with the real rating count per restaurant — string label e.g. "(214)"
    const fouxRatingCounts = ["(214)", "(229)", "(178)", "(257)", "(205)", "(154)", "(233)", "(182)"];
    // FOUX_TODO: end
    // FOUX_TODO: replace with the real distance/time info per restaurant — string label e.g. "12 min · 0.4 mi"
