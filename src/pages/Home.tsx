...
import { FouxDropAccContractH2 } from "../components/FouxDropAccContractH2/FouxDropAccContractH2";
...
export function Home({ isFavorite, onFavorite, onViewMenu, onToast }: HomeProps): React.ReactNode {
    ...
    const fouxSections: [import('../components/FouxDropAccContractH2/FouxDropAccContractH2').AccordionSection, import('../components/FouxDropAccContractH2/FouxDropAccContractH2').AccordionSection, import('../components/FouxDropAccContractH2/FouxDropAccContractH2').ActionsSection] = [
