...
import { FouxOptTestDynSingle } from "../components/FouxOptTestDynSingle/FouxOptTestDynSingle";
...
export function Home({ isFavorite, onFavorite, onViewMenu, onToast }: HomeProps): React.ReactNode {
    // FOUX_TODO: replace with the real rating review count for the featured restaurant
    const fouxRatingCount = '(214)';

    // FOUX_TODO: replace with distance and estimated travel time from user location
