...
import { FouxDropAccContractG2 } from "../components/FouxDropAccContractG2/FouxDropAccContractG2";
...
export function Home({ isFavorite, onFavorite, onViewMenu, onToast }: HomeProps): React.ReactNode {
    ...
    const fouxDropAccMenuLabel = 'Menu';
    // FOUX_TODO: replace placeholder accordion sections
    const fouxDropAccSections: import('../components/FouxDropAccContractG2/FouxDropAccContractG2').AccordionSection[] = [
  ...
  return (
    <div>
      <FouxDropAccContractG2
                  menuLabel={fouxDropAccMenuLabel}
                  sections={fouxDropAccSections}
