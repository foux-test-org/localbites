...
export function Home({ isFavorite, onFavorite, onViewMenu, onToast }: HomeProps): React.ReactNode {
    ...
    const fouxSections: [import('../components/FouxDropAccTest/FouxDropAccTest').AccordionSection, import('../components/FouxDropAccTest/FouxDropAccTest').AccordionSection, import('../components/FouxDropAccTest/FouxDropAccTest').AccordionSection] = [
