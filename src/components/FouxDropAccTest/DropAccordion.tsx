...
export interface AccordionSection {
  title: string;
  body: string;
  /** If true, renders Cancel + Agree buttons inside the panel body */
  hasActions?: boolean;
}
        ...
        return (
          ...
          >
            ...
            <div
              ...
              hidden={!isExpanded}
              className={`${styles.panelBody}${isExpanded ? ' ' + styles.isOpen : ''}`}
            >
              {/* FOUX_TODO: Section 1 body contents (collapsed, not shown in image) — wire real content here when available */}
